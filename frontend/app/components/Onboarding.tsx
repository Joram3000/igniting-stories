...
import styles from '@/app/components/Onboarding.module.scss'
import {studioUrl} from '@/sanity/lib/api'

const iconStyle = {height: '2.5rem', width: '2.5rem', margin: '0 auto'}
      ...
      <div>
        {!isPresentation ? (
          <Link className={styles.link} href={link.href} target="_blank">
            {link.title}
            {(link.showIcon ?? true) && (
              <svg className={styles.linkIcon} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
...
const icon = (
  ...
  >
    <rect width="512" height="512" fill="#2f2154" rx="30" />
    <path
    ...
    <div className={styles.box}>
      ...
      <OnboardingMessage
        message={{
          ...
          description: 'Maak het eerste interview aan in Sanity Studio.',
        }}
        link={{
          title: 'Verhaal aanmaken',
    ...
    <div className={styles.box}>
      ...
      <OnboardingMessage
        message={{
          ...
          description: 'Maak de pagina aan in Sanity Studio.',
        }}
        link={{
